...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "galactic/spacefarer/spacefarerui/test/integration/SpacefarersListJourney.gen",
    "galactic/spacefarer/spacefarerui/test/integration/SpacefarersObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
